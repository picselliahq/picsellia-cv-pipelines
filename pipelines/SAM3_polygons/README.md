...
**How to use**:
```toml
# Only segment objects in the region x:100-500, y:100-600
...
# Only segments persons within the specified box
```
...
**When to use**:
```toml
# Segment anything in the box, label it as "region_of_interest"
