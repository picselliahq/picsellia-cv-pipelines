...
from pipelines.yolov8.training.segmentation.pipeline_utils.steps_utils.model_prediction.segmentation_model_context_predictor import (
    UltralyticsSegmentationModelContextPredictor,
)
...
def evaluate_ultralytics_model_context(
    ...
    elif model_context.loaded_model.task == "segment":
        model_context_predictor = UltralyticsSegmentationModelContextPredictor(
            model_context=model_context
        )
    else:
