...
from utils.parameters import MaskRCNNExportParameters, TrainingHyperParameters
...
context = create_training_context_from_config(
    ...
    export_parameters_cls=MaskRCNNExportParameters,
    mode=args.mode,
...
def training_pipeline():
    ...
    picsellia_model = build_model(pretrained_weights_name="checkpoint-latest")
